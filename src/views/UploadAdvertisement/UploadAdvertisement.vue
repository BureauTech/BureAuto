            ...
            >
              <v-card>
                <v-card-title class="text-h6">
                  Alguns anúncios não foram cadastrados. Deseja baixar o arquivo de erros?
                </v-card-title>
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn
...
<script src="./UploadAdvertisement.js" scoped></script>

<style src="./UploadAdvertisement.css"></style>