...
create table chat (
	...
	cha_usu_cod bigint not null,
	cha_anu_cod varchar not null,
	constraint chat_cha_cod_pkey primary key (cha_cod),
    constraint chat_cha_usu_cod_fkey foreign key (cha_usu_cod) references usuario (usu_cod),
	constraint chat_cha_anu_cod_fkey foreign key (cha_anu_cod) references anuncio (anu_cod)
);
...
create table message (
    ...
    mes_usu_cod bigint not null,
    mes_cha_cod bigint not null,
    mes_text varchar not null,
    constraint message_mes_cod_pkey primary key (mes_cod),
    constraint message_usu_cod_fkey foreign key (mes_usu_cod) references usuario (usu_cod),
